...
if ($task_title && $task_desc) {
  if ($conn) {
    ...
    $insert_task = $conn->prepare('INSERT INTO tasks (task_title, task_desc, task_user, task_due) VALUES (:task_title, :task_desc, :task_user, :task_due)');
    ...
    $insert_task->bindParam(':task_due', $task_due);
    $insert_task->execute();
